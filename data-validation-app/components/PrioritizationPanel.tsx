...
export default function PrioritizationPanel() {
  ...
  const PrioritySlider = ({
    ...
    <div className="space-y-3">
      ...
      <Slider
        value={[value]}
        onValueChange={(values) => updatePriority(key, values[0])}
        max={100}
        step={5}
        className="w-full"
      />
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <PrioritySlider
            ...
            value={priorities.resourceAvailability}
          ...
          <PrioritySlider
            ...
            key="taskComplexity"
            value={priorities.taskComplexity}
